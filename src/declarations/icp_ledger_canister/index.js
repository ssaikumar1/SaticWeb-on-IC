 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_ledger_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_ledger_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_ledger_canister.did.js")._SERVICE>}
 */
