...
import { idlFactory } from './static_canister.did.js';
export { idlFactory } from './static_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STATIC_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./static_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the static_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./static_canister.did.js")._SERVICE>}
 */
export const static_canister = createActor(canisterId);
